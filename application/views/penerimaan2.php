					...
					<form method="POST" id="frm1" name="penerimaan" class='form-horizontal'>
						...
						<div class="control-group">
							...
							<div class="controls controls-row">
								...
								<select style="margin-left: 2.5641%;" name="JenisSpesimen" id="JenisSpesimen" class='span3' onchange="document.frm1.JenisSpesimen.value=this.value" >
