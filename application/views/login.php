...
<head>
	...
	<script type="text/javascript">
        ...
        function lab(){
            $.ajax({
                url:'<?php echo $application_path;?>/login/lab/'+$ID('Lab').value,
	...
	<img src="<?php echo $application_path; ?>/img/logo-dinkes.png" alt="Logo" />
		...
		<div class="login">
			...
			<input type="hidden" name="statpos" value="0"/>
				<select name="Lab" id="Lab" class='input-block-level' onchange="lab(this.value)">
				...
				<div class="input-xxlarge" id="div_penelitian">
