...
<body>
		...
		<table width="100%" border="0">
		  ...
		  <tr>
			<td width="20%">Penelitian</td>
			<td width="3%" align="center">:</td>
			<?php
				foreach($penelitian as $value):
			?>
			<td align="left"><?php echo $value['penelitian_kode']; ?> - ( <?php echo $value['penelitian_name'];?> )</td>			
			<?php
				endforeach;
			?>
			<td>&nbsp;</td>
		...
		<!--<table width="100%" border="1">-->
			<tr>
				...
				<td width="6%" align="center">Jenis Penelitian</td>
			...
			<tr>
				...
				<td align="center"><?php echo $value['penelitian_name']; ?></td>
