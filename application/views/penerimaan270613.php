	...
	function reload(value) {
		jQuery.ajax({
			...
			complete: function(res, status) {
				...
				var vserum = document.penerimaan.Serum;
			...
			<div class="box">
				...
				<div class="box-body">
					<form method="POST" id="frm1" name="penerimaan" class='form-horizontal'>
                        ...
                        <div class="control-group">
							<label for="Serum" class="control-label">Diambil Serum</label>
							<div class="controls controls-row">
								<select name="Serum" id="Serum" class='span2'>
									<option value="0"> - Diambil Serum - </option>
