<script type="text/javascript">
        ...
        function getbox(idrevco,norak){
            $.ajax({
                url:'<?=$application_path;?>/list_penerimaantiga/get_arr_box/'+idrevco+'/'+norak,
        ...
        function kapasitasRak(idrevco){
            $.ajax({
                url:'<?=$application_path;?>/list_penerimaantiga/get_kapasitas/'+idrevco,
                complete:function(res,status){
        ...
        function hapus(id){
            $.ajax({
                url:'<?php echo $application_path;?>/list_penerimaantiga/hapusaliquote/'+id,
                complete: function(res, status){
        ...
        function tampiltabel(){
            $.ajax({
                            url:'<?php echo $application_path;?>/list_penerimaantiga/tampilTabel/'+$ID('NoBarcode').value,
                            complete: function(res, status){
        ...
        function tampilkotak(){
         $.ajax({
                url:'<?php echo $application_path;?>/list_penerimaantiga/tampil_kotak/'+$('#Box').val()+'/'+$('#Revco').val()+'/'+$('#Rack').val()+'/'+$('#TypeBox').val(),
                complete: function(res, status){
                    var kotak = res.responseText;
        ...
        function tampilkotakisi(box,revco,rak,typebox,kotak){
         ...
         $.ajax({
                ...
                url:'<?php echo $application_path;?>/list_penerimaantiga/tampil_kotak/'+box+'/'+revco+'/'+rak+'/'+typebox+'/'+kotak,
                complete: function(res, status){
                    var kotak = res.responseText;
                    document.getElementById('kotaktampil').innerHTML=res.responseText;
                }
        ...
        function tampilkotaktabel(){
            $.ajax({
                url:'<?php echo $application_path;?>/list_penerimaantiga/tampil_tabel_kotak/'+$('#Box').val()+'/'+$('#Revco').val()+'/'+$('#Rack').val()+'/'+$('#TypeBox').val(),
        ...
        function tampilkotakisitabel(box,revco,rak,typebox){
         ...
         $.ajax({
                ...
                url:'<?php echo $application_path;?>/list_penerimaantiga/tampil_tabel_kotak/'+box+'/'+revco+'/'+rak+'/'+typebox,
                complete: function(res, status){
                    var kotak = res.responseText;
                    document.getElementById('tabelkotak').innerHTML=res.responseText;
                }
       ...
       function typebox(idbox){
            ...
            $.ajax({
                url:'<?php echo $application_path;?>/list_penerimaantiga/get_typebox/'+idbox,
                complete:function(res,status){
...
//file penerimaan
	...
	function delete_link(formpenerimaan_id) {
        ...
        function kabupaten(){
            $.ajax({
                            url:'<?php echo $application_path;?>/list_penerimaantiga/kabupaten/'+$ID('Prov').value,
                            complete: function(res, status){
                                //var kotak = res.responseText;
        ...
        function kecamatan(){
                    $.ajax({
                                    url:'<?php echo $application_path;?>/list_penerimaantiga/kecamatan/'+$ID('Prov').value+'/'+$ID('Kota').value,
                                    complete: function(res, status){
                                        //var kotak = res.responseText;
        ...
        function kelurahan(){
                    $.ajax({
                                    url:'<?php echo $application_path;?>/list_penerimaantiga/kelurahan/'+$ID('Prov').value+'/'+$ID('Kota').value+'/'+$ID('Kec').value,
                                    complete: function(res, status){
                                        //var kotak = res.responseText;
...
//        });
	...
	function reload(value) {
		jQuery.ajax({
			url:'<?php echo $application_path; ?>/list_penerimaantiga/nobarcode/'+value,
			complete: function(res, status) {
				...
				<form method="POST" class='form-horizontal'>
						...
						<div class="pull-right">
							<div class="btn-toolbar">
								...
								<div class="btn-group">
									<a href="#" onclick="goto('list_penerimaantiga/?laman=1')" class="button button-basic button-icon" ><i>First</i></a>
									<a href="#" onclick="goto('list_penerimaantiga/?laman=<?php echo ($laman-1) ?>')" class="button button-basic button-icon" ><i>Previous</i></a>
									<a href="#" onclick="goto('list_penerimaantiga/?laman=<?php echo $laman ?>')" class="button button-basic button-icon" ><i> <?php echo $laman ?> </i></a>
									<a href="#" onclick="goto('list_penerimaantiga/?laman=<?php echo ($laman+1) ?>')" class="button button-basic button-icon" ><i>Next</i></a>
									<a href="#" onclick="goto('list_penerimaantiga/?laman=-1')" class="button button-basic button-icon" ><i>Last</i></a>
								</div>
							</div>
						</div>
					</div>
