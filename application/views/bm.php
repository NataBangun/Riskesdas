					...
					<div class="span12">
						<div class="box">
							...
							<div class="box-body box-body-nopadding">
								...
								<div class="control-group">
									<div class="controls controls-row">
										<input type="text" name="Prov" id="Prov" placeholder="32" class="span1" />
										<input type="text" name="Kota" id="Kota" placeholder="01" class="span1" />
										<input type="text" name="Kec" id="Kec" placeholder="110" class="span1" />
										<input type="text" name="Desa" id="Desa" placeholder="002" class="span1" />
										<input type="text" name="DK" id="DK" placeholder="D" class="span1" />
										<input type="text" name="KodeSampel" id="KodeSampel" placeholder="2505002" class="span3" />
										<input type="text" name="NoUrut" id="NoUrut" placeholder="015" class="span1" />
									</div>
								</div>
								<div class="control-group">
