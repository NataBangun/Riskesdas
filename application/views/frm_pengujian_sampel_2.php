...
$(function(){
    ...
    $.ajax({
        type    : "POST",
        url     : '<?php echo $application_path;?>/frm_pengujian_sampel/get_method',
        data    : $("#frm1").serialize(),
        complete: function(rs){
            var rt=rs.responseText;
            window.open("<?php echo $application_path;?>/frm_pengujian_sampel/print_pengujian"+rt, "frm_pengujian_sampel", '');
        }
    });
	}
...
<p id="JENIS_AIR"></p>		
				...
				<div class="box-body">
					<form method="POST" id="frm1" name="formsam" class='form-horizontal'>
						...
						<input type="hidden" name="status_addujisam" value="0">
