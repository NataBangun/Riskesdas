		...
		<div class="span12">
			<div class="box">
				<div class="box-head">
					...
					<span>Data Laporan Penerimaan</span>
				</div>
				<div class="box-body box-body-nopadding">
					<div class="highlight-toolbar">
						<div class="pull-left">
							<div class="btn-group">
								<a href="#" onclick="goto('laporan_penerimaan/')" class="button button-basic button-icon" >Kembali</a>
							</div>
				...
				<!--form method="POST" class='form-horizontal'>
						...
						<div class="pull-right">
							<div class="btn-toolbar">
								...
								<div class="btn-group">
									<a href="#" onclick="goto('laporan_penerimaan/tampilkan/?laman=1')" class="button button-basic button-icon" ><i>First</i></a>
									<a href="#" onclick="goto('laporan_penerimaan/tampilkan/?laman=<?php echo ($laman-1) ?>')" class="button button-basic button-icon" ><i>Previous</i></a>
									<a href="#" onclick="goto('laporan_penerimaan/tampilkan/?laman=<?php echo $laman ?>')" class="button button-basic button-icon" ><i> <?php echo $laman ?> </i></a>
									<a href="#" onclick="goto('laporan_penerimaan/tampilkan/?laman=<?php echo ($laman+1) ?>')" class="button button-basic button-icon" ><i>Next</i></a>
									<a href="#" onclick="goto('laporan_penerimaan/tampilkan/?laman=-1')" class="button button-basic button-icon" ><i>Last</i></a>
								</div>
							</div>
						</div>
					</div>
					...
					<table class="table table-nomargin table-bordered table-pagination">
						<thead>
							<tr>
								<th width="1%">No.</th>
								<th width="15%"><center>No Barcode</center></th>
								<th width="10%"><center>Propinsi</center></th>
								<th width="13%"><center>Spesimen<center></th>
								<th width="13%"><center>Kondisi</center></th>
								<th width="7%">Visit Ke</th>
								<th width="7%">Nama Site</th>
								<th width="10%" class="table-data"><center>Tgl Ambil</center></th>
								<th width="10%" class='table-date'>Diterima Tanggal</th>
								<th width="11%" style="display:none"><center>Action</center></th>
							</tr>
						</thead>
						<tbody>
							<?php
								if (empty($arr_formpenerimaan )) {
									echo '<tr><td colspan="13" style="color:red;"><center><b> Tidak ada Data. </b><center></td></tr>';
								}
							?>
							<?php 
								$no = 1 + $laman_offset;
