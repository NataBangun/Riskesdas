			...
			<div class="box">
				...
				<div class="box-body">
					<form method="POST" id="frm1" name="formhasil" class='form-horizontal'>
						...
						<div class="control-group">
							<div class="controls controls-row">
								<input readonly="" type="text" name="Prov" id="Prov" class="span1" />
								<input readonly="" type="text" name="Kota" id="Kota" class="span1" />
								<input readonly="" type="text" name="Kec" id="Kec" class="span1" />
								<input readonly="" type="text" name="Desa" id="Desa" class="span1" />
								<input readonly="" style="width:3%;" type="text" name="DK" id="DK" class="span1" />
								<input readonly="" style="margin-left:4.5%;" type="text" name="KodeSampel" id="KodeSampel" class="span2" />
								<input readonly="" style="margin-left:4%;" type="text" name="NoSensus" id="NoSensus" class="span1" />
								<input readonly="" style="margin-left:11%" type="text" name="NoUrut" id="NoUrut" class="span1" />
						...
						<div class="control-group">
							...
							<div class="controls controls-row">
								<input readonly="" type="text" name="Umur" id="Umur" class="span1" />
						...
						<div class="control-group">
							...
							<div class="controls controls-row">
								<input readonly="" type="text" name="JK" id="JK" class="span2" />
						...
						<div class="control-group">
							...
							<div class="controls controls-row">
								<input type="text" data-placement="right" rel="tooltip" title="Masukkan No Stiker, kemudian ENTER." name="NoStiker" id="NoStiker" class="span2" onkeyup="nostiker(event)"/>
