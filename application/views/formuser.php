...
//		}
	...
	function edit_link_action(t_suser_id) {  
		...
		combobox_select($('#dialog select[name="lepel"]'), $('#userid'+t_suser_id+ ' input[name="lvl"]').val());
									...
									<div class="control-group">
										...
										<div class="controls controls-row" id="div_penelitian">
											<select name="Penelitian" id="Penelitian">
												...
												<option value="<!?php echo $value['penelitian_kode']; ?>"><!?php echo $value['penelitian_name']." ($value[penelitian_kode])" ?></option-->
												<!--?php endforeach; ?-->
											</select>
