...
function ambil(no){
    ...
    $('#tb1').append(
        ...
        +   '<td>'+ $('#nobarcode'+no).val() +'<input type="hidden" name="no_barcode'+idjml.value+'" value="'+ $('#nobarcode'+no).val() +'" ></td>'
...
function penelitian(){
            $.ajax({
                url:'<?php echo $application_path;?>/ups/pengambilan/peneliti/'+$ID('LabPenelitian').value,
...
//    });
    ...
    $('#btn_addsampel').click(function(){
        if($ID('LabPenelitian').value==''||$ID('Penelitian').value==''){
                ...
                <div class="box-body">
                    <form method="POST" id="frm1" name="pengambilana" class='form-horizontal'>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls controls-row">
                                        <select name="LabPenelitian" id="LabPenelitian" class='span3'  onchange="penelitian(this.value)">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls controls-row" id="div_penelitian">
                                <select name="Penelitian" id="Penelitian" class='span4' >
                                        <option value=""> - Silakan Pilih Laboraturium Terlebih Dahulu - </option>
                        ...
                        <div class="control-group">
                            <div class="control-label">
                                <button id="btn_addsampel" type="button" class="button button-basic-blue" >Tambah Sampel</button>
                            </div>                        
                        </div>
						...
						<tbody id="tb1">
                            ...
                            if(isset($dt_ambil)){
                                ...
                                foreach($dt_ambil as $value){
                                    ...
                                    <tr>
                                        <td>$i</td>
                                        <td>$value[no_barcode] <input type=\"hidden\" name=\"no_barcode$i\" value=\"$value[no_barcode]\" ></td>
