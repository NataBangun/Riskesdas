...
function pengembalian_print(){
    ...
    $.ajax({
        type    : "POST",
        url     : '<?php echo $application_path;?>/ups/pengembalian/get_method',
        data    : $("#frm1").serialize(),
        complete: function(rs){
            var rt=rs.responseText;
            window.open("<?php echo $application_path;?>/ups/pengembalian/print_pengembalian/"+rt, "Pengembalian", '');
        }
    });
}
...
function get_pengambilan(laman){
    ...
    $.ajax({
        url:'<?php echo $application_path;?>/ups/pengembalian/get_laman'+laman,
        data:{
...
function getJumlah(id){
    $.ajax({
        url:'<?php echo $application_path;?>/ups/pengembalian/getJumlah',
        data:{'id':id},
        complete:function(res,status){
...
function getAmbil(id){
    $.ajax({
        url:'<?php echo $application_path;?>/ups/pengembalian/getAmbil',
        data:{'id':id},
        complete:function(res,status){
...
function pilih(id){
    ...
    getJumlah(id);
    $.ajax({
        url:'<?=$application_path;?>/ups/pengembalian/pilih',
        data:{'id':id},
...
<!--UI DIALOG-->
<div id="dlg_cari" title="Add Sampel">
