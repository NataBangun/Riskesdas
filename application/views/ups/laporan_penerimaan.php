				...
				<div class="box-body box-body-nopadding">
					<div class="tab-content">
						...
						<div class="tab-pane" id="penelitian">
							...
							<div class="row-fluid">
								<form method="POST" action="<?php echo $application_path; ?>/ups/view_exportpen/index/"  id="frm1" name="penform" class='form-horizontal'>
            						<div class="control-group">
						...
						<div class="tab-pane" id="tgl">
							...
							<div class="row-fluid">
								<form method="POST" action="<?php echo $application_path; ?>/ups/view_exporttgl/index/" id="frm1" name="tglform" class='form-horizontal'>
            						<div class="control-group">
            							<label for="tglawal" class="control-label">Taggal Awal</label>
            							<div class="controls controls-row">
            								<input type="text" name="tglawal" id="tglawal" placeholder="dd/mm/yyyy" class="span2 datepick" maxlength="10" />
						...
						<div class="tab-pane" id="js">
							...
							<div class="row-fluid">
								<form method="POST" action="<?php echo $application_path; ?>/ups/view_exportspes/index/" id="frm1" name="jsform" class='form-horizontal'>
            						<div class="control-group">
						...
						<div class="tab-pane" id="revco">
							...
							<div class="row-fluid">
								<form method="POST" action="<?php echo $application_path; ?>/ups/view_exportjenpen/index/" id="frm1" name="jsform" class='form-horizontal'>
            						<div class="control-group">
						...
						<div class="tab-pane" id="konspe">
							...
							<div class="row-fluid">
								<form method="POST" action="<?php echo $application_path; ?>/ups/view_exportkonspes/index/" id="frm1" name="jsform" class='form-horizontal'>
            						<div class="control-group">
