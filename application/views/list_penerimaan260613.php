...
//file penerimaan
	...
	function delete_link(formpenerimaan_id) {
        ...
        function kecamatan(){
                    $.ajax({
                                    url:'<?php echo $application_path;?>/list_penerimaan/kecamatan/'+$ID('Prov').value+'/'+$ID('div_kota').value,
                                    complete: function(res, status){
                                        //var kotak = res.responseText;
        ...
        function kelurahan(){
                    $.ajax({
                                    url:'<?php echo $application_path;?>/list_penerimaan/kelurahan/'+$ID('Prov').value+'/'+$ID('div_kota').value+'/'+$ID('div_kec').value,
                                    complete: function(res, status){
                                        //var kotak = res.responseText;
        ...
        function edit_wilayah(_id){
	   $.ajax({
                            url:'<?php echo $application_path;?>/list_penerimaan/kabupaten/'+$ID('Prov').value,
                            complete: function(res, status){
                                //var kotak = res.responseText;
                                document.getElementById('div_kota').innerHTML=res.responseText;
                                combobox_select($('#dialog-update select[name="Kota"]'), $('#formpenerimaan_'+_id+ ' input[name="Kota"]').val());
                                $.ajax({
                                    url:'<?php echo $application_path;?>/list_penerimaan/kecamatan/'+$ID('Prov').value+'/'+$ID('div_kota').value,
                                    complete: function(res, status){
                                        //var kotak = res.responseText;
                                        document.getElementById('div_kec').innerHTML=res.responseText;
                                        combobox_select($('#dialog-update select[name="Kec"]'), $('#formpenerimaan_'+_id+ ' input[name="Kec"]').val());
                                        $.ajax({
                                    url:'<?php echo $application_path;?>/list_penerimaan/kelurahan/'+$ID('Prov').value+'/'+$ID('div_kota').value+'/'+$ID('div_kec').value,
                                    complete: function(res, status){
                                        //var kotak = res.responseText;
                                        document.getElementById('div_kel').innerHTML=res.responseText;
                                        combobox_select($('#dialog-update select[name="Desa"]'), $('#formpenerimaan_'+_id+ ' input[name="Desa"]').val());
                                    }
                                });
                                    }
                                });
	...
	function edit_link_action(formpenerimaan_id) {  
		...
		$('#dialog-update input[name="NoStiker"]').val( $('#formpenerimaan_'+formpenerimaan_id+ ' input[name="NoStiker"]').val() );
                ...
                jmlAliquot();
                edit_wilayah(formpenerimaan_id);
        } 
		...
		<form method="POST" id="frm1" name="penerimaan" class='form-horizontal'>
			...
			<div class="control-group">
				...
				<div class="controls controls-row">
					...
					<label style="margin-left:23.5%" for="TGLKirim" class="control-label">TGL Kirim</label>
					<input style="margin-left: 2.5641%;" type="text" name="TGLKirim" id="TGLKirim" placeholder="dd/mm/yyyy" class="span1 datepick" />
			...
			<div class="control-group">
				...
				<div class="controls controls-row">
					...
					<label style="margin-left: 4%;" for="DiambilTanggal" class="control-label">Diambil Tanggal</label>
					<input style="margin-left: 2.5641%;" type="text" name="DiambilTanggal" id="DiambilTanggal" placeholder="dd/mm/yyyy" class="span1 datepick" />
                    
			<label style="width:13%" for="TGLDiterima" class="control-label">Diterima Tgl</label>
            <input style="margin-left:1%" type="text" name="TGLDiterima" id="TGLDiterima" placeholder="dd/mm/yyyy" class="span2 datepick" />
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls controls-row">
					<input type="text" name="Alamat" id="Alamat" placeholder="" class="span3" />
					
					<label style="margin-left: 3.8%;" for="AWB" class="control-label">AWB</label>
			...
			<div class="control-group">
				...
				<div class="controls controls-row">
					<div>
						<select class="span3" name="Prov" id="Prov" onchange="kabupaten(this.value)">
					...
					<label style="margin-left: 3.8%;" for="Ket" class="control-label">Keterangan</label>
			...
			<div class="control-group">
				...
				<div class="controls controls-row">
					<div>
						<select class="span3" name="Kota" id="div_kota" onchange="kecamatan(this.value)">
							
						</select>
					</div>
					
					<label style="margin-left:4%"for="jmlAliquot" class="control-label">Jumlah Aliquot</label>
			...
			<div class="control-group">
				...
				<div class="controls controls-row">
					<div>
						<select class="span3" name="Kec" id="div_kec" onchange="kelurahan(this.value)">
						</select>
					</div>
			...
			<div class="control-group">
				...
				<div class="controls controls-row">
					<div>
						<select class="span3" name="Desa" id="div_kel">
