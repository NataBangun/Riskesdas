<script type="text/javascript">
	...
	function addaformmalaria_submit() {
		...
		var vPF = document.malariaform.PF;
		//var vPF = document.getElementById(PF);
		var vpv = document.malariaform.PV;
		var vpo = document.malariaform.PO;
		var vpm = document.malariaform.PM;
		var vSpesiesLoka = document.malariaform.SpesiesLoka;
	    var vPar = document.malariaform.Par;
	    var vPar2 = document.malariaform.Par2;
	    var vPar3 = document.malariaform.Par3;
	    var vPar4 = document.malariaform.Par4;
		var vLemkos = document.malariaform.Lemkos;
		var vLemkos2 = document.malariaform.Lemkos2;
		var vLemkos3 = document.malariaform.Lemkos3;
		var vLemkos4 = document.malariaform.Lemkos4;
	...
	<div class="box-body">
		<form method="POST" id="frm1" name="malariaform" class='form-horizontal'>
			...
			<div class="control-group">
				...
				<label style="margin-left:25%;width:18%" for="Alamat" class="control-label"><b><u>Parameret Loka</u></b></label>
			...
			<div class="control-group">
				...
				<label style="margin-left:14%;" for="PN2" class="control-label">Positif/Negatif</label>
			...
			<div class="control-group">
							...
							<div class="controls controls-row">
								...
								<input style="width: 5%;" type="text" name="PF" id="PF" class="span1" maxlength="1" />
                                
							<label style="width: 2%;margin-left:2%;" for="PV" class="control-label">PV</label>
								<input style="margin-left:2%;width: 5%;" type="text" name="PV" id="PV" class="span1" maxlength="1" />
							<label style="width: 2%;margin-left:2%;" for="PO" class="control-label">PO</label>
								<input style="margin-left:2%;width: 5%;" type="text" name="PO" id="PO" class="span1" maxlength="1" />
							<label style="width: 2%;margin-left:2%;" for="PM" class="control-label">PM</label>
								<input style="margin-left:2%;width: 5%;" type="text" name="PM" id="PM" class="span1" maxlength="1" />
                                
							<label style="margin-left:3%;" for="SpesiesLoka" class="control-label">Spesies</label>
								<input style="margin-left:2.5%;width: 5%;" type="text" name="SpesiesLoka" id="SpesiesLoka" class="span1" maxlength="1" />
						...
						<div class="control-group">
							...
							<div class="controls controls-row">
								<input style="width: 5%;" type="text" name="Par" id="Par" class="span1" maxlength="4" onchange="autodensitas()" />
								<input style="margin-left:6%;width: 5%;" type="text" name="Par2" id="Par2" class="span1" maxlength="4" onchange="autodensitas2()" />
								<input style="margin-left:6%;width: 5%;" type="text" name="Par3" id="Par3" class="span1" maxlength="4" onchange="autodensitas3()" />
								<input style="margin-left:6%;width: 5%;" type="text" name="Par4" id="Par4" class="span1" maxlength="4" onchange="autodensitas4()" />
							</div>
						</div>
						<div class="control-group">
							<label for="Lemkos" class="control-label">Leukosit</label>
							<div class="controls controls-row">
								<input style="width: 5%;" type="text" name="Lemkos" id="Lemkos" class="span1" maxlength="4" onchange="autodensitas()" />
								<input style="margin-left:6%;width: 5%;" type="text" name="Lemkos2" id="Lemkos2" class="span1" maxlength="4" onchange="autodensitas2()" />
								<input style="margin-left:6%;width: 5%;" type="text" name="Lemkos3" id="Lemkos3" class="span1" maxlength="4" onchange="autodensitas3()" />
								<input style="margin-left:6%;width: 5%;" type="text" name="Lemkos4" id="Lemkos4" class="span1" maxlength="4" onchange="autodensitas4()" />
							</div>
						</div>
						<div class="control-group">
							<label for="Densitas" class="control-label">Densitas</label>
							<div class="controls controls-row">
								...
								<input style="width: 8.5%;margin-left:2.5%;" type="text" name="Densitas2" id="Densitas2" class="span2" maxlength="8" />
								<input style="width: 8.5%;margin-left:2.5%;" type="text" name="Densitas3" id="Densitas3" class="span2" maxlength="8" />
								<input style="width: 8.5%;margin-left:2.5%;" type="text" name="Densitas4" id="Densitas4" class="span2" maxlength="8" />
							</div>
						</div>
			<div class="control-group">
