...
<script type="text/javascript" src="<?php echo base_url()?>js/terbilang.js"></script>
...
<div align="center">
  <table width="815" border="0">
    ...
    <tr>
      ...
      <td>&nbsp;</td>
      <td width="355">&nbsp;</td>
      <td width="287"><div align="center"><?php echo $value['TEMPAT']; ?>, <?php echo $value['TGL_PENERIMAAN']; ?></div></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
