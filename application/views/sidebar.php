			...
			<!--div class="search">
				...
				<ul style="margin:12px 8px;" class="mainNav" data-open-subnavs="multi">
					...
					<?php
                                                ...
                                                if ($this->data['penelitian'] =="R1" AND $this->data['level'] ==4 ) {
                                                    echo "<li>
									...
									<ul class=\"subnav\">
										...
										<li>
											<a href=\"#\" onclick=\"goto('laporan_pemeriksaan_riskesdas/')\">Laporan Pemeriksaan</a>
										</li>
									</ul>
                                                            </li>"
                                                    ;
                                                }
						else if ($this->data['penelitian'] =="K2" AND $this->data['level'] ==3 ) {
							echo "
							
								<li>
									<a href=\"#\"><span>Forms</span><span class=\"label\">1</span></a>
									<ul class=\"subnav\">
									
										<li>
											<a href=\"#\" onclick=\"goto('frm_pengujian_sampel_air/')\">Form Pengujian Sementara</a>
										</li>
                                                                                <li>
											<a href=\"#\" onclick=\"goto('laporan_hasil_pengujian/')\">Form Hasil Pengujian</a>
										</li>
									</ul>
								</li>
						...
						}else if ($this->data['penelitian'] =="K2" AND $this->data['level'] ==4 ) {
							echo "
							...
							";
						}else if ($this->data['penelitian'] =="K2" AND $this->data['level'] ==6 ) {
							echo "
								...
								<li>
									...
									<ul class=\"subnav\">
										...
										<li>
											<a href=\"#\" onclick=\"goto('frm_pengujian_sampel/')\">Form Permohonan</a>
										</li>
                                                                                <li>
											<a href=\"#\" onclick=\"goto('frm_kwitansi_pemeriksaan_air/')\">Form Print Kwitansi</a>
										</li>
									</ul>
								</li>
							...
							echo "
								...
								<li>
									...
									<ul class=\"subnav\">
										<li>
											<a href=\"#\" onclick=\"goto('list_pemeriksaan/')\">Laporan Pemeriksaan</a>
										</li>
										<li>
											<a href=\"#\" onclick=\"goto('laporan_Penerimaan/')\">Laporan Penerimaan</a>
										</li>
