<script type='text/javascript' src='<?php echo $application_path; ?>/js/jquery-1.9.1.js'></script>
<script type="text/javascript" src="<?php echo $application_path; ?>/js/jquery-ui.js"></script>
...
var dates = $("#tglawal, #tglakhir").datepicker({
    defaultDate: "+1w",
    changeMonth: true,
    numberOfMonths: 1,
    onSelect: function(selectedDate) {
        var option = this.id == "tglawal" ? "minDate" : "maxDate",
						...
						<div class="tab-pane active">
							...
							<div class="row-fluid">
								...
								<form method="POST" id="frm1" name="labform" class='form-horizontal' action="./tampilkan/">
            						...
            						<div class="control-group">
									<link rel="stylesheet" href="<?php echo $application_path; ?>/js/jquery-ui.css" type="text/css" media="all">
            							<label for="tglawal" class="control-label"></label>
            							<div class="controls controls-row">
            								<input type="text" id="tglawal" name="tglawal" value="Dari tanggal" onClick="document.getElementById('tglakhir').disabled=false"/>
            								<input type="text" id="tglakhir" name="tglakhir" value="Ke tanggal" disabled /><br>
