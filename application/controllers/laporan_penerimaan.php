...
class laporan_penerimaan extends main {
	...
	{	
		parent::index();
		$this->session->set_userdata('laporan_penerimaan', $_POST);
		...
		$this->data['area_body'] = $this->load->view('laporan_penerimaan', $this->data, true);
	...
	public function tampilkan()
	{
		...
		// print_r($_POST);
		$this->data['area_body'] = $this->load->view('laporan_penerimaan_tampilkan', $this->data, true);
		$this->data['judul'] = 'Form Laporan Penerimaan';
		$this->load->view('layout', $this->data);
