...
class list_penerimaandua extends main {
	...
	public function index()
	{
		...
		$this->data['status_editpenerimaan'] = "0"; // default
			...
			if (isset($_POST['status_editpenerimaan'])) {
				...
				nama_pengirim=?, tgl_ambil=?, tgl_terima=?, AWB=?, ket=?, jumaliquot=? where formpenerimaan_id=?',
					...
					$_POST['TGLDiterima'], $_POST['AWB'], $_POST['Ket'], $_POST['hjmlAliquot'],$_POST['formpenerimaan_id']));
...
//	
			...
			if ( $this->data['level'] == "" or $this->data['welcome'] == "") {
				...
				$this->data['area_body'] = $this->load->view('list_penerimaandua', $this->data, true);
			}
