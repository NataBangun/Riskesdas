...
class pengembalian extends main{
    ...
    function __construct(){
        ...
        $this->data['NoPengembalian']   = isset($_REQUEST['NoPengembalian']) ? htmlspecialchars($_REQUEST['NoPengembalian']): "";
        ...
        <table class=\"table2 table2-striped table2-nomargin table2-mail\">
                        ...
                        ";
                            ...
                            echo'<tr id="tr'.$i.'">
                                ...
                                <td><input type="text" id="nopengambilan'.$i.'" value="'.$value['no_formpengambilan'].'" style="border:none;width:auto;background:none" disabled></td>
                                <td><input type="text" id="tgl_serahterima'.$i.'" value="'.$value['tgl_serahterima'].'" style="border:none;width:100px;background:none" disabled></td>
                                <td><input type="text" id="yangmenerima'.$i.'" value="'.$value['yg_menyerahkan'].'" style="border:none;width:100px;background:none" disabled></td>
                                <td><input type="text" id="yangmenyerahkan'.$i.'" value="'.$value['yg_menerima'].'" style="border:none;width:100px;background:none" disabled>
                                <input type="hidden" id="keterangan'.$i.'" value="'.$value['ket'].'" style="border:none;width:100px;background:none" disabled></td></td>
                                <td>
    ...
    public function index(){
    	...
    	if ( $this->data['level'] == "" or $this->data['welcome'] == "") {
			...
			$this->data['area_body'] = $this->load->view('ups/pengembalian', $this->data, true);
		}
