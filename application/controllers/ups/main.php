...
class main extends CI_Controller {
	...
	{
		$this->data['home'] = $this->load->view("ups/home", $this->data, true);
		$this->data['area_sidebar'] = $this->load->view("ups/sidebar", $this->data, true);
		$this->data['area_top'] = $this->load->view("ups/top", $this->data, true);
