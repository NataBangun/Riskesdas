...
$this->get_arr_formpenerimaan();
		...
		$this->get_arr_revco();
			...
			if (isset($_POST['status_terima'])) {
				...
				nama_pengirim=?, tgl_ambil=?, tgl_terima=?, AWB=?, ket=?, jumaliquot=?',
					...
					$_POST['TGLDiterima'], $_POST['AWB'], $_POST['Ket'], $_POST['hjmlAliquot']));
		...
		// propinsi_id kabupaten_id kecamatan_id kelurahan_id no_stiker no_barcode institusi_kode penelitian_kode namaART umurART JK alamatART spesimen_kode kondisispesimen_id
		...
		// Prov Kota Kec Desa NoStiker NoBarcode AsalInstitusi NamaPenelitian NamaART umurART JK Alamat 
		...
		$this->data['arr_propinsi'] = $rows;
			...
			if ( $this->data['level'] == "" or $this->data['welcome'] == "") {
				...
				$this->data['area_body'] = $this->load->view('ups/penerimaan', $this->data, true);
			}
