...
class list_pemeriksaan extends main {
    ...
    public function get_arr_pemeriksaan(){
        ...
        if($tgl_awal != '' && $tgl_akhir != ''){
            ...
            $sql .= " WHERE STR_TO_DATE(tgl_terima,'%d/%m/%Y')  BETWEEN '$tgl_awal' AND '$tgl_akhir'";
        }
        if($provinsi != 0 ){
        ...
        if(trim($sql)!=''){
            ...
            if (empty($arr_pemeriksaan)) {
                echo '<tr><td colspan="6"><center><b style="color:red;"> Silakan Pilih Metode. </b><center></td></tr>';
            }
