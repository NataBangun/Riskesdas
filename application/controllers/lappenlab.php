...
class lappenlab extends main {
	...
	public function index($Id=""){	
		...
		header('Content-Disposition: attachment; filename=laporan_lab.xls');
		...
		$this->data['area_body'] = $this->load->view('lappenlab', $this->data, true);
		$this->data['judul'] = 'Form Export Laporan Penerimaan';
		$this->load->view('lappenlab', $this->data);
	}
}
