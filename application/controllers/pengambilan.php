...
class pengambilan extends main{
    function __construct(){
        ...
        $this->data['getMethod'] .= 'labcode='.$this->data['labcode'].'&'
										.'NoPengambilan='.$this->data['NoPengambilan'].'&'
    ...
    public function get_laman(){
        ...
        $dataambil = explode(',',trim($_REQUEST['dataambil']));
        ...
        <table class=\"table2 table2-striped table2-nomargin table2-mail\">
						<thead>
							<tr>
								...
								<th width=\"30%\" class='table-date'>Tgl. Terima</th>
                        ...
                        ";
                            ...
                            echo'<tr id="tr'.$i.'">
                                ...
                                <td><input type="text" id="tgl_terima'.$i.'" value="'.$value['tgl_terima'].'" style="border:none;width:100px;background:none" disabled></td></td>
                            ...
                            echo'</td>
                                <td>
                                    ...
                                    if((!in_array($value['no_barcode'],$dataambil))&&($value['status']==0)){
                                        echo '<a id="ambil'.$i.'" href="#" class="btn" onclick="ambil('.$i.')">Ambil</a>';
                                    }
                                    '
                                </td>
                            </tr>
    ...
    public function index(){
        ...
        $penelitiancode = $this->session->userdata('penelitian');
        if (isset($_POST['status_pengambilan'])) {
            if($_POST['status_pengambilan']==0){
                $this->db->query("
                    ...
                    date_input          = '$date',
                    LAB_CODE            = '$labcode',
                    penelitian_kode     = '$penelitiancode'
                ");
                echo $_POST['status_pengambilan'];
